...
import { FiUser, FiCalendar, FiUserPlus, FiCheckSquare, FiPlusCircle, FiXCircle, FiEdit, FiChevronsLeft } from 'react-icons/fi';
import { useLocation, useNavigate  } from 'react-router-dom';
import { useSelector } from "react-redux";

function Project(){
    const {email, token, userId} = useSelector(state => state.userReducer);
    ...
    React.useEffect(() => {
        axios
            ...
            .then((response) => {
                ...
                setCommits(response.data.projectPlans);
            });
        axios
    ...
    function addRequirement(requirementId) {
        ...
        var data = {
            ...
            ;
        axios
            .post(`${process.env.REACT_APP_API_URL}/project/competence`, data)
            .then((response) => {
    ...
    function addCommit() {
        ...
        axios
        .post(`${process.env.REACT_APP_API_URL}/project/plan`, data)
        .then((response) => {
    ...
    function addParticipant() {
        ...
        axios
        .post(`${process.env.REACT_APP_API_URL}/project/response`, data)
        .then((response) => {
        })
        .catch((error) => {
        });
