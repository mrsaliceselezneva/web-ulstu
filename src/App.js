  ...
  if (token === 'unauthorized') {
    ...
    return (
      <Routes>
        ...
        <Route exact path="/sponsors" element={<Drawer central={<Investors />} page={6} />} />
        <Route exact path="/sponsors/sponsor/*" element={<Drawer central={<Investor />} page={6} />} />

        <Route exact path="/timetable" element={<Drawer central={<Timetable />} page={7} />} />
